...
/* Called for every WM_KEY* before accelerators (layout-independent input). */
typedef void (*Win32_Key_Notify_Callback)( UINT message, WPARAM wParam, LPARAM lParam );
extern Win32_Key_Notify_Callback Win32_Key_Notify_Callback_Ptr;
