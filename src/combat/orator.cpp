...
OratorClass::Save (ChunkSaveClass &csave)
{
	csave.Begin_Chunk (CHUNKID_VARIABLES);
		...
		WRITE_MICRO_CHUNK_WIRE_POINTER (csave, VARID_CONVERSATION,	Conversation);
		...
		WRITE_MICRO_CHUNK_WIRE_POINTER (csave, VARID_OLD_PTR, old_ptr);
...
OratorClass::Load_Variables (ChunkLoadClass &cload)
{
	...
	while (cload.Open_Micro_Chunk ()) {
		switch (cload.Cur_Micro_Chunk_ID ()) {
			...
			READ_MICRO_CHUNK_WIRE_POINTER (cload, VARID_CONVERSATION,		Conversation);
