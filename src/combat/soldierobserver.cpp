...
bool	SoldierObserverClass::Save (ChunkSaveClass &csave)
{
	...
	if ( CombatManager::Are_Observers_Active() ) {
		csave.Begin_Chunk( CHUNKID_VARIABLES );
			...
			WRITE_MICRO_CHUNK_WIRE_POINTER( csave, MICROCHUNKID_COVER_POSITION, CoverPosition );
			...
			case CHUNKID_VARIABLES:
				while (cload.Open_Micro_Chunk()) {
					switch(cload.Cur_Micro_Chunk_ID()) {
						...
						READ_MICRO_CHUNK_WIRE_POINTER( cload, MICROCHUNKID_COVER_POSITION, CoverPosition );
