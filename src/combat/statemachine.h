...
#define ADD_STATE_TO_MACHINE_IMPL(classname, machine, state)		\
		machine.Add_State (								\
			(typename StateClass<classname>::THINK_PTR)(&classname::On_##state##_Think), \
			(typename StateClass<classname>::REQUEST_END_PTR)(&classname::On_##state##_Request_End), \
			(typename StateClass<classname>::BEGIN_PTR)(&classname::On_##state##_Begin), \
			(typename StateClass<classname>::END_PTR)(&classname::On_##state##_End))
...
#define DECLARE_STATE(state, begin, end, think, req_end)			\
		...
		bool On_##state##_Request_End (int new_state) req_end
...
public:
	...
	void	Add_State
	(
		typename StateClass<T>::THINK_PTR think_ptr,
		typename StateClass<T>::REQUEST_END_PTR request_ptr,
		typename StateClass<T>::BEGIN_PTR begin_ptr,
		typename StateClass<T>::END_PTR end_ptr
	)
	{
		StateClass<T> state;
