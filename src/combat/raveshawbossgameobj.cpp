	...
	RestoreFirstPerson (true)
{
	...
	//	
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_NOTHING);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_HEALING);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_THROWING_OBJECT);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_THROWING_SOLDIER);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_THROWING_STAR);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_GRAB_STAR);	
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_JUMP_TO_CATWALK);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_ON_CATWALK);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_BODYSLAM);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_CHASE_STAR);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_DAZED);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_FLEE);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, OverallState, OVERALL_STATE_DEATH_SEQUENCE);

	//
	//	Register the Raveshaw states with its state machine
	//
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_NOTHING);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_ROAR);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_GRAB_TIBERIUM);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_GRAB_SOLDIER);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_THROW_SOLDIER);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_GRAB_OBJECT);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_THROW_OBJECT);	
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_GRAB_STAR);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_BODYSLAM);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_JUMP_DOWN);	
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_STUMBLE);	
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_LOOK_CONFUSED);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_DYING);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_FALL);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, RaveshawState, RAVESHAW_STATE_DEATH_LANDING);	
	
	//
	//	Register the Move states with its state machine
	//
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, MoveState, MOVE_STATE_STOP);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, MoveState, MOVE_STATE_GOTO_TIBERIUM);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, MoveState, MOVE_STATE_GOTO_CATWALK);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, MoveState, MOVE_STATE_JUMP_TO_CATWALK);	
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, MoveState, MOVE_STATE_CIRCLE_CATWALK);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, MoveState, MOVE_STATE_GOTO_THROW_OBJECT);		
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, MoveState, MOVE_STATE_JUMP_TO_STAR);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, MoveState, MOVE_STATE_FOLLOW_STAR);

	//
	//	Register the Engorged states with its state machine
	//
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, EngorgedState, ENGORGED_STATE_NONE);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, EngorgedState, ENGORGED_STATE_ABSORBING_TIBERIUM);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, EngorgedState, ENGORGED_STATE_FADING);

	//
	//	Register the Jump states with its state machine
	//
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, JumpState, JUMP_STATE_NONE);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, JumpState, JUMP_STATE_CROUCHING);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, JumpState, JUMP_STATE_JUMPING);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, JumpState, JUMP_STATE_LANDING);
	JumpState.Set_State (JUMP_STATE_NONE);
	
	//
	//	Register the Stealth Soldier states with its state machine
	//
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, StealthSoldierState, STEALTH_SOLDIER_STATE_NONE);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, StealthSoldierState, STEALTH_SOLDIER_STATE_DISPLAY);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, StealthSoldierState, STEALTH_SOLDIER_STATE_FLYING);	
	StealthSoldierState.Set_State (STEALTH_SOLDIER_STATE_NONE);

	//
	//	Register the Stealth Soldier states with its state machine
	//
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, HavocState, HAVOC_STATE_NONE);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, HavocState, HAVOC_STATE_GRABBED);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, HavocState, HAVOC_STATE_FLYING);	
	HavocState.Set_State (HAVOC_STATE_NONE);	

	//
	//	Register the Thrown object states with its state machine
	//
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, ThrownObjectState, THROWN_OBJECT_STATE_NONE);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, ThrownObjectState, THROWN_OBJECT_STATE_PICKUP);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, ThrownObjectState, THROWN_OBJECT_STATE_FLYING);	
	ThrownObjectState.Set_State (THROWN_OBJECT_STATE_NONE);

	//
	//	Register the Lightning Rod states with its state machine
	//
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, LightningRodState, LIGHTNING_ROD_STATE_NONE);
	ADD_STATE_TO_MACHINE_IMPL(RaveshawBossGameObjClass, LightningRodState, LIGHTNING_ROD_STATE_ACTIVE);
