...
public:
	...
	*/
	...
	/* Win32 scancode path (MinGW/Wine); layout-independent movement keys. */
	static void Notify_Win32_Key( UINT message, WPARAM wParam, LPARAM lParam );
	...
	*/
	...
	static void		Set_Menu_Mouse_Mode (bool menu_mode);
