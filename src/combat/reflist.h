...
class ReferencerClass : public PostLoadableClass {
	...
	public:
		...
		ReferencerClass( void ) : ReferenceTarget( NULL ), TargetReferencerListNext( NULL ), IsLoadPending( false ) {}
		ReferencerClass( const ScriptableGameObj * target ) : ReferenceTarget( NULL ), TargetReferencerListNext( NULL ), IsLoadPending( false ) { *this = target; }
		...
		ScriptableGameObj *	Get_Ptr (void) const;
