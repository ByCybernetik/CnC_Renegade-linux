...
VehicleDriverClass::Save (ChunkSaveClass &csave)
{
	csave.Begin_Chunk (CHUNKID_VARIABLES);
		...
		WRITE_MICRO_CHUNK_WIRE_POINTER (csave, VARID_PATH_PTR,					m_CurrentPath);
		WRITE_MICRO_CHUNK_WIRE_POINTER (csave, VARID_GAME_OBJ_PTR,			m_GameObj);
...
VehicleDriverClass::Load_Variables (ChunkLoadClass &cload)
{
	...
	while (cload.Open_Micro_Chunk ()) {
		switch (cload.Cur_Micro_Chunk_ID ()) {
			...
			READ_MICRO_CHUNK_WIRE_POINTER (cload, VARID_PATH_PTR,				m_CurrentPath);
			READ_MICRO_CHUNK_WIRE_POINTER (cload, VARID_GAME_OBJ_PTR,			m_GameObj);
