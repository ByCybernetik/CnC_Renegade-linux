...
DECLARE_SCRIPT(M01_Mission_Controller_JDG, "")//this guys ID number is 100376
{
	...
	void Created( GameObject * obj ) 
	{
		...
		Commands->Set_Background_Music( "01-command&conquer.mp3" );
			...
			switch (param)
			{
				...
				case M01_COMMCENTER_SAMSITE_HAS_BEEN_DESTROYED_JDG://Comm Center sam site has been destroyed--duh!
					{	
						...
						if (player_has_unlocked_pen == true)
						{
							...
							Commands->Join_Conversation(NULL, unlocked_gate_conv, false, false, false);
				...
				case M01_PLAYER_IS_APPROACHING_CHURCH_JDG://cue church actors
					{	
						...
						Commands->Join_Conversation(NULL, church_upadate, false, false, false);
						//Commands->Join_Conversation( STAR, church_upadate, false, false, false);
				...
				case M01_ANNOUNCE_HON_OBJECTIVE_JDG://player is approaching hand of nod--give objective
					{
						...
						Commands->Join_Conversation(NULL, hand_of_nod_conv, false, false, false);
				...
				case M01_PLAYER_HAS_POKED_PEN_GATE_JDG:
					{
						if (player_has_unlocked_pen != true)
						{
							if (first_time_poking_gate_lock == true)
							{
								...
								Commands->Join_Conversation(NULL, prisoner_conv, false, false, false);
				...
				case M01_ANNOUNCE_COMMCENTER_SAM_OBJECTIVE_JDG:
					{
						...
						Commands->Join_Conversation(NULL, comm_sam_conv, false, false, false);
						//Commands->Join_Conversation( STAR, comm_sam_conv, false, false, false);
				...
				case M01_ANNOUNCE_UNLOCK_GATE_OBJECTIVE_JDG:
					{
						...
						Commands->Join_Conversation(NULL, unlock_gate_conv, false, false, false);
				...
				case M01_CUE_LOVESHACK_NUN_CONVERSATION_JDG:
					{
						...
						if (loveshackNun != NULL && (church_guard_is_dead != true))
						{
							if (loveshack_conv_playing == false)
							{
								...
								Commands->Join_Conversation(NULL, loveshack_conv, false, false, false);
								//Commands->Join_Conversation( STAR, loveshack_conv, false, false, false);
				...
				case M01_ANNOUNCE_TURRETS_OBJECTIVE_JDG:
					{
						...
						Commands->Join_Conversation(NULL, turrets_conv, false, false, false);
						Commands->Join_Conversation(NULL, turrets_conv, false, false, false);
				...
				case M01_ADD_TURRETS_OBJECTIVE_JDG:
					{
						...
						Commands->Join_Conversation(NULL, c4_conv, false, false, false);
				...
				case M01_END_TURRETS_OBJECTIVE_PASS_JDG:
					{
						if (turret_objective_over == false)
						{
							...
							if (gunboat != NULL)
							{
								...
								Commands->Join_Conversation(NULL, turrets_conv_02, false, false, false);
							...
							else
							{
								...
								//Commands->Join_Conversation(NULL, turrets_hummVee_conv, false, false, false);
								//Commands->Join_Conversation( STAR, turrets_hummVee_conv, false, false, false);
				...
				case M01_ANNOUNCE_BARN_OBJECTIVE_JDG:
					{
						if (barn_announcement_active == false)
						{
							...
							Commands->Join_Conversation(NULL, barn_conv, false, false, false);
							Commands->Join_Conversation( STAR, barn_conv, false, false, false);
				...
				/*case M01_CHANGE_BARN_OBJECTIVE_JDG:
					{
						if (barn_objective_failed != true)
						{
							...
							Commands->Join_Conversation(NULL, roundupcivs_conv, false, false, false);
				...
				case M01_END_BARN_ROUNDUP_OBJECTIVE_JDG:
					{
						if (barn_objective_ended == false)
						{
							...
							/*if (barn_objective_failed == true)
							{
								...
								Commands->Join_Conversation(NULL, barnfailed_conv, false, false, false);
								Commands->Join_Conversation( STAR, barnfailed_conv, false, false, false);
				...
				case M01_CUE_BILLYS_CONVERSATION_JDG:
					{
						...
						if ( barnPrisoner02 != NULL && barn_prisoner_02_is_dead != true) //this is billy
						{
							...
							Commands->Join_Conversation(NULL, billy_conv, false, false, false);
				...
				case M01_CUE_KANE_AND_HAVOC_CONVERSATION_JDG://player is in comm center war room--cue kane encounter
					{
						...
						if (kane_and_havoc_conv_active == false)
						{
							...
							if (kane != NULL)
							{
								...
								Commands->Join_Conversation( STAR, kane_and_havoc_conv, false, false, false);
			...
			case ACTION_COMPLETE_CONVERSATION_ENDED: 
				{
					...
					else if (action_id == barnfailed_conv) 
					{
						...
						//Commands->Join_Conversation(NULL, honAlerted_conv, false, false, false);
						//Commands->Join_Conversation( STAR, honAlerted_conv, false, false, false);
...
DECLARE_SCRIPT(M01_Player_Is_Entering_Tailgun_Alley_JDG, "")//this guys ID is 101692
{
	void Entered( GameObject * obj, GameObject * enterer )
	{
		if (enterer == STAR)
		{
			...
			Commands->Join_Conversation(NULL, tankWarning, false, false, false);
			Commands->Join_Conversation(NULL, tankWarning, false, false, false);
			//Commands->Join_Conversation( STAR, tankWarning, false, false, false);
		...
		if (type == 0)
		{
			if (param == M01_START_ACTING_JDG)
			{
				if (deadYet == false)
				{
					...
					Commands->Join_Conversation(NULL, lockeHarvester, false, false, false);
	...
	void Custom( GameObject * obj, int type, intptr_t param, GameObject * sender ) 
	{
		if (param == M01_GOING_TO_EVAC_SPOT_JDG)
		{
			...
			if (unitsEvacuated == 4)
			{
				...
				Commands->Join_Conversation(NULL, airdrop_conv, false, false, false);
			...
			case ACTION_COMPLETE_CONVERSATION_ENDED: 
				{
					if (action_id == missionIntro) //add first objective pog here
					{
						...
						Commands->Join_Conversation(NULL, escKeyConv, false, false, false);
	...
	void Custom( GameObject * obj, int type, intptr_t param, GameObject * sender ) 
	{
		if (type == 0)
		{
			if (param == M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG)
			{
				...
				Commands->Join_Conversation(NULL, missionIntro, false, false, false);
				//Commands->Join_Conversation( STAR, missionIntro, false, false, false);
...
DECLARE_SCRIPT(M01_Church_EvacController_JDG, "")//103394 
{
	...
	void Custom( GameObject * obj, int type, intptr_t param, GameObject * sender ) 
	{
		if ((param == M01_START_ACTING_JDG))//civs have been freed--play protect civs conversation
		{
			...
			Commands->Join_Conversation(NULL, protectCivsConv, false, false, false);
			//Commands->Join_Conversation( STAR, protectCivsConv, false, false, false);
...
DECLARE_SCRIPT(M01_Tiberium_Cave_Spawn_Helicopter_Zone_JDG, "")//M01_TIB_TUNNEL_HELICOPTER_ZONE_JDG...this guys ID is 100955
{
	void Entered( GameObject * obj, GameObject * enterer )
	{
		if (enterer == STAR )
		{
			...
			Commands->Join_Conversation(NULL, apacheConv, false, false, false);
...
DECLARE_SCRIPT(M01_GDI_GuardTower_NOD_Commander_JDG, "")//M01_BARNAREA_NOD_COMMANDER_JDG
{
	...
	void Killed( GameObject * obj, GameObject * killer ) 
	{
		...
		if (STAR)
		{
			...
			Commands->Join_Conversation(NULL, guardTowerOutro, false, false, false);
			//Commands->Join_Conversation( STAR, guardTowerOutro, false, false, false);
				...
				case M01_START_ACTING_JDG: //here comes player start calling in reinforcements
					{
						...
						if (STAR && deadYet == false)
						{
							...
							Commands->Join_Conversation(NULL, guardTowerIntro, false, false, false);
							//Commands->Join_Conversation( STAR, guardTowerIntro, false, false, false);
...
DECLARE_SCRIPT(M01_KeyCard01_Script_JDG, "")
{
	void Custom( GameObject * obj, int type, intptr_t param, GameObject * sender ) 
	{
		if ( type == CUSTOM_EVENT_POWERUP_GRANTED ) 
		{
			...
			Commands->Join_Conversation(NULL, lockeKeycard, false, false, false);
...
DECLARE_SCRIPT(M01_GDIBase_LightTank_JDG, "")//M01_TAILGUNAREA_NOD_LIGHTTANK_JDG 102435
{
	void Killed( GameObject * obj, GameObject * killer ) 
	{
		...
		Commands->Join_Conversation(NULL, tankReward, false, false, false);
		//Commands->Join_Conversation( STAR, tankReward, false, false, false);
	...
	void Custom( GameObject * obj, int type, intptr_t param, GameObject * sender ) //
	{
		...
		else if (param == M01_GOING_TO_EVAC_SPOT_JDG)
		{
			...
			if (unitsEvacuated == 3 && failed == false)
			{
				...
				Commands->Join_Conversation(NULL, barnAirdrop_conv, false, false, false);
...
DECLARE_SCRIPT(M01_First_AutoRifle_JDG, "")
{
	void Custom( GameObject * obj, int type, intptr_t param, GameObject * sender ) 
	{
		if ( type == CUSTOM_EVENT_POWERUP_GRANTED ) 
		{
			...
			Commands->Join_Conversation(NULL, pressEnterConv, false, false, false);
...
DECLARE_SCRIPT(M01_Announce_First_ObjectiveZone_JDG, "")//116380
{
	void Created( GameObject * obj ) 
	{
		...
		Commands->Join_Conversation(NULL, pressF1Conv, false, false, false);
		...
		if (obj)
		{
			...
			if (healthPercentage <= 50)
			{
				if (secondHealthWarningPlayed == false)
				{
					...
					Commands->Join_Conversation(NULL, gunboatHealthWarning02, false, false, false);
					Commands->Join_Conversation(NULL, gunboatHealthWarning02, false, false, false);
					Commands->Join_Conversation( STAR, gunboatHealthWarning02, false, false, false);
			...
			else if (healthPercentage <= 75)
			{
				if (firstHealthWarningPlayed == false)
				{
					...
					Commands->Join_Conversation(NULL, gunboatHealthWarning01, false, false, false);
					Commands->Join_Conversation(NULL, gunboatHealthWarning01, false, false, false);
		...
		if (enterer == STAR)
		{
			...
			if (mctCommander != NULL)
			{
				...
				if ((mctProtector01 != NULL) && (mctProtector02 != NULL))
				{
					...
					Commands->Join_Conversation( mctProtector02, protectMct_conv, false, false, false);
					Commands->Join_Conversation( mctProtector01, protectMct_conv, false, false, false);
