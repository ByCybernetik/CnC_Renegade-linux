...
#ifndef	SCRIPT_DLL_SCRIPTS_H
#define	SCRIPT_DLL_SCRIPTS_H

#include "scriptevents.h"
#include "scriptcommands.h"
#if defined(__GNUC__) && defined(BUILDING_DLL)
...
public:
	...
	// Get a parameter as an integer (returns defaultValue if name not found)
	int Get_Int_Parameter(const char* parameterName, int defaultValue = 0);
...
#if defined(__GNUC__) && defined(BUILDING_DLL)
extern ScriptCommandsProxy* Commands;
#else
