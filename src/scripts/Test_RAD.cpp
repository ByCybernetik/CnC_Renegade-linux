...
DECLARE_SCRIPT (MX0_A02_Controller, "")
{
		...
		case (MX0_A02_CUSTOM_TYPE_MAIN_ENDING):
			{
				...
				while (count < MX0_A02_ACTOR_HEADCOUNT)
				{
					...
					if (actor)
					{
						Commands->Send_Custom_Event(obj, actor, MX0_A02_CUSTOM_TYPE_MAIN_ENDING, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
					count++;
				}
		...
		case (MX0_A02_CUSTOM_TYPE_HANDOFF_SNIPER_01_ID):
			{
				if (sender)
				{
					Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_KILL_SNIPER_01, MX0_A01_NOD_SNIPER_01, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_HANDOFF_SNIPER_02_ID):
			{
				if (sender)
				{
					Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_KILL_SNIPER_02, MX0_A01_NOD_SNIPER_02, 0);
				}
				break;
			}
		...
		case (MX0_A02_CUSTOM_TYPE_MAIN_STARTUP):
			{
				if (!ran_startup)
				{
					...
					if (a01_controller)
					{
						Commands->Send_Custom_Event(obj, a01_controller, MX0_A02_CUSTOM_TYPE_GET_SNIPER_01_ID, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						Commands->Send_Custom_Event(obj, a01_controller, MX0_A02_CUSTOM_TYPE_GET_SNIPER_02_ID, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
		...
		case (MX0_A02_CUSTOM_TYPE_STARTUP):
			{
				...
				if (!player_retreat)
				{
					...
					if (sniper)
					{
						...
						if (soldier)
						{
							Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_KILL_SNIPER_01, MX0_A01_NOD_SNIPER_01, 0);
						}
					}
					else
					{
						...
						if (sniper)
						{
							...
							if (soldier)
							{
								Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_KILL_SNIPER_02, MX0_A01_NOD_SNIPER_02, 0);
							}
						}
					}
					...
					if (soldier)
					{
						Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_01, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
					...
					if (apc)
					{
						Commands->Send_Custom_Event(obj, apc, MX0_A02_CUSTOM_TYPE_STARTUP, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
				}
			}
		...
		case (MX0_A02_CUSTOM_TYPE_CONTINUE):
			{
				...
				while (nod_count < MX0_A02_ACTOR_HEADCOUNT)
				{
					...
					if (soldier)
					{
						Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_DAMAGE_ON, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
					nod_count++;
				}
		...
		case (MX0_A02_CUSTOM_TYPE_START_GDI_02):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_02, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_START_GDI_03):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_03, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_START_GDI_04):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_04, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_START_GDI_05):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_START_GDI_05, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_PLAYER_KILLED_NOD):
			{
				...
				if (soldier)
				{
					...
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_PLAYER_CONGRATS, congrats_loop, 0);
					congrats_loop++;
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_SOLDIER_KILLED_NOD):
			{
				...
				if (soldier)
				{
					...
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SOLDIER_CONGRATS, soldier_congrats_loop, 0);
		...
		case (MX0_A02_CUSTOM_TYPE_GDI_NOTICES_NOD_01):
			{
				...
				if (soldier)
				{
					...
					if (target)
					{
						Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_NOD_01, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_01):
			{
				...
				if (soldier)
				{
					...
					if (target)
					{
						Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_01, MX0_A02_UNIT_ID[current_nod_target], 0);
					}
				}
		...
		case (MX0_A02_CUSTOM_TYPE_GDI_RESPONDS_01):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_RESPONDS_01, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_02):
			{
				...
				if (soldier)
				{
					...
					if (target)
					{
						Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_02, MX0_A02_UNIT_ID[current_nod_target], 0);
					}
				}
				break;
			}
		...
		case (MX0_A02_CUSTOM_TYPE_GET_APC_ID):
			{
				...
				if (apc)
				{
					if (sender)
					{
						Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_TYPE_GET_APC_ID, MX0_A02_GDI_APC_ID, 0);
					}
				}
				else
				{
					if (sender)
					{
						Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_TYPE_GET_APC_ID, 0, 0);
					}
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_HELI_DESTROYED):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_HELI_DESTROYED, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME_DEAD):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME_DEAD, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		...
		case (MX0_A02_CUSTOM_TYPE_ENDING_02):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_02, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_ENDING_03):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_03, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_ENDING_04):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_04, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_ENDING_05):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_05, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		...
		case (MX0_A02_CUSTOM_TYPE_ENGINEER_MOVETOTANK):
			{
				if (sender)
				{
					...
					Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_TYPE_ENGINEER_MOVETOTANK, MX0_A02_MED_TANK_ID, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_ENGINEER_DONE):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SAY_TANK, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
		...
		case (MX0_A02_CUSTOM_TYPE_ENTERED_TANK):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SAY_FIREHOLE, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_EXPLODE):
			{
				...
				if (debris)
				{
					Commands->Create_Explosion ("Ground Explosion 01 - Harmless", Vector3(-71.233f, -41.517f, 0.181f), NULL);					Commands->Set_Animation(debris, "AG_L0_BLOCKAGE1.AG_L0_BLOCKAGE1", false, NULL, 0.0f, -1.0f, false);
					Commands->Start_Timer (obj, this, 2.0f, MX0_A02_TIMER_DESTROY_RUBBLE);
				}
				GameObject * soldier = Commands->Find_Object (MX0_A02_UNIT_ID[1]);
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_FOLLOW_HAVOC, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
		...
		case (MX0_A02_CUSTOM_TYPE_SAY_APC_DOWN):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SAY_APC_DOWN, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				break;
			}
		case (MX0_A02_CUSTOM_TYPE_SHOOT_HELI_02):
			{
				...
				while (count < 5)
				{
					...
					if (soldier)
					{
						Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SHOOT_HELI_02, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
					count++;
				}
			}
	...
	void Timer_Expired (GameObject * obj, int timer_id)
	{
		...
		case (MX0_A02_TIMER_PRE_AMBIENT):
			{
				if (pre_ambient_on)
				{
					...
					if (soldier)
					{
						Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_PRE_AMBIENT, pre_ambient_count, 0);
					}
					pre_ambient_count++;
		...
		case (MX0_A02_TIMER_PLAYER_RETREAT):
			{
				if (player_retreat)
				{
					...
					if (distance > MX0_A02_PLAYER_RETREAT_DISTANCE)
					{
						...
						if (soldier)
						{
							Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_PLAYER_RETREAT, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
					}
		...
		case (MX0_A02_TIMER_AFTER_HELI_01):
			{
				Commands->Send_Custom_Event(obj, obj, MX0_A02_CUSTOM_TYPE_NEXT_SEQUENCE, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				break;
			}
		case (MX0_A02_TIMER_NOD_RETREAT):
			{
				...
				while (count < MX0_A02_ACTOR_HEADCOUNT)
				{
					if (MX0_A02_UNIT_ID[count])
					{
						...
						if (soldier)
						{
							Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_RETREAT_SEQUENCE, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
					}
					count++;
				}
		...
		case (MX0_A02_TIMER_RETREAT_DONE):
			{
				...
				while (count < MX0_A02_ACTOR_NOD_START)
				{
					...
					if (soldier)
					{
						Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_RETREAT_DONE, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						if (count == 2)
						{
							Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_ENDING_01, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
					}
					count++;
				}
					...
					case (0):
						{
							...
							if (soldier)
							{
								Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_TANKSAY_01, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
							}
							break;
						}
					case (1):
						{
							...
							if (soldier)
							{
								Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_TANKSAY_02, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
							}
							break;
						}
					case (2):
						{
							...
							if (soldier)
							{
								Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_TANKSAY_03, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
							}
							break;
						}
					default:
		...
		case (MX0_A02_TIMER_WRONG_WAY):
			{
				...
				if (soldier)
				{
					Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_SAY_WRONG_WAY, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
...
DECLARE_SCRIPT (MX0_A02_ACTOR, "ActorID=0:int")
{
	...
	void Created (GameObject * obj)
	{
		...
		if (!actor_id)
		{
			Commands->Send_Custom_Event(obj, obj, MX0_A02_CUSTOM_TYPE_DEFAULT_STATE_ON, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
		}
		else
		{
			switch (actor_id)
			...
			case (5): // Nod FlameThrower jumps down and fires at targets until dead.
				{
					...
					if (controller)
					{
						Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
					break;
				}
					...
					case (1):
						{
							...
							if (controller)
							{
								Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_RESPONDS_01, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
							}
							break;
						}
					case (2):
	...
	void Killed (GameObject * obj, GameObject * killer)
	{
		if (active_actor)
		{
			...
			if (controller)
			{
				if (killer == STAR)
				{
					Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_PLAYER_KILLED_NOD, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
				}
				else
				{
					if (killer)
					{
						...
						Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_SOLDIER_KILLED_NOD, killer_id, 0);
					}
				}
				if (my_register_id >= MX0_A02_ACTOR_NOD_START)
				{
			...
			case (MX0_A02_CUSTOM_KILL_SNIPER_01):
				{
					...
					if (sniper)
					{
						...
						else
						{
							...
							if (controller)
							{
								Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_HANDOFF_SNIPER_02_ID, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
							}
						}
					}
					else
				...
				case (MX0_A02_SPEECH_GDI_01_STARTUP):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_START_GDI_02, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_GDI_02_STARTUP):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_START_GDI_04, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_GDI_01_STARTUP_02):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_START_GDI_05, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_GDI_02_BECKON):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_START_GDI_03, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_GDI_03_STARTUP):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_CONTINUE, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_GDI_NOTICES_NOD_01):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_01, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_ENDING_01):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_02, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_ENDING_02):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_03, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_ENDING_03):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_04, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_ENDING_04):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_05, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_ENDING_05):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENDING_06, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_ENGINEER_DONE):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENGINEER_DONE, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_TANKSAY_04):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_EXPLODE, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_SPEECH_GDI_SPOTS_HELI_02):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_SHOOT_HELI_02, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				default:
				...
				case (MX0_A02_ACTION_BASIC_MOVE_02):
					{
						if (default_state)
						{
							...
							if (controller)
							{
								Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_REQUEST_TARGET, my_register_id, 0);
							}
						}
						break;
					}
				...
				case (MX0_A02_ACTION_NODFALL01_MOVE):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_NOD_01, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_ACTION_NODFALL02_MOVE):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_02, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_ACTION_NOD_MOVETO_APC):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GET_APC_ID, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
				case (MX0_A02_ACTION_NOD_SHOOT_APC):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_SAY_APC_DOWN, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						ActionParamsStruct params;
						params.Set_Basic(this, MX0_A02_PRIORITY_FORCED_ACTION, MX0_A02_ACTION_NOD_DONEWITH_APC);
						params.Set_Movement(Vector3(-78.442f,-78.044f,6.404f), RUN, 0.5f, false);
				...
				case (MX0_A02_ACTION_NOD_DONEWITH_APC):
					{
						...
						if (controller)
						{
							Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_NEXT_SEQUENCE, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
						}
						break;
					}
			...
			case (MX0_A02_TIMER_WAITFOR_MOVETOTANK):
				{
					...
					if (controller)
					{
						Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENGINEER_MOVETOTANK, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
					break;
				}
			case (MX0_A02_TIMER_WAITFOR_MOVETORUBBLE):
				{
					...
					if (controller)
					{
						Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENGINEER_02_REGISTER, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
					}
					ActionParamsStruct params;
...
DECLARE_SCRIPT (MX0_A02_GDI_MEDTANK, "")
{
	...
	void Custom(GameObject * obj, int type, intptr_t param, GameObject * sender)
	{
		if ((type == CUSTOM_EVENT_VEHICLE_ENTERED) && (!entered))
		{
			...
			if (controller)
			{
				Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENTERED_TANK, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
			}
		}
	}
};
...
DECLARE_SCRIPT (MX0_A02_ZONE_STARTUP, "")
{
	void Entered (GameObject * obj, GameObject * enterer)
	{
		...
		if (controller)
		{
			Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_STARTUP, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
			Commands->Destroy_Object (obj);
		}
	}
};
...
DECLARE_SCRIPT (MX0_A02_HELICOPTER, "ActorID=0:int")
{
	...
	void Killed (GameObject * obj, GameObject * killer)
	{
		...
		if (!actor_id)
		{
			...
			if (controller)
			{
				Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_HELI_DESTROYED, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
			}
		}
		else
		{
			...
			if (controller)
			{
				Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_HELI_DESTROYED_02, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
			}
		}
	}
...
DECLARE_SCRIPT (MX0_A02_ZONE_DEFAULT_ON, "")
{
	void Entered (GameObject * obj, GameObject * enterer)
	{
		...
		if (controller)
		{
			Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_MAIN_STARTUP, MX0_A02_CUSTOM_PARAM_DEFAULT, 0);
			Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GET_SNIPER_01_ID, 1200017, 0);
			Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GET_SNIPER_02_ID, 1200023, 0);
		}
	}
};
