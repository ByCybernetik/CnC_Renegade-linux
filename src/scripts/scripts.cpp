...
#include <string.h>
#include <stdio.h>
#if defined(__GNUC__) && defined(_WIN32) && defined(BUILDING_DLL)
#endif
...
ScriptCommandsProxy* Commands = &g_ScriptCommandsProxy;
#else
...
int ScriptImpClass::Get_Int_Parameter(const char* parameterName, int defaultValue)
{
