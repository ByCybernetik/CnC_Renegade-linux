...
DECLARE_SCRIPT(MDD_Objective_Controller, "")
{
	...
	void Created(GameObject * obj)
	{
		...
		//DEMO Commands->Add_Objective(201, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_M02_OBJECTIVE_01, NULL, 0);
		//DEMO Commands->Add_Objective(222, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, IDS_M02_OBJECTIVE_22, NULL, 0);
		//DEMO Commands->Add_Objective(223, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, IDS_M02_OBJECTIVE_23, NULL, 0);
	}
...
DECLARE_SCRIPT (MDD_Respawn_Controller, "")
{
	...
	void Created (GameObject *obj)
	{
		...
		//DEMO Commands->Send_Custom_Event(obj, Commands->Find_Object(400985), 0, 0, 0);
		//DEMO Turn on A25
		GameObject * object = Commands->Find_Object(M02_OBJCONTROLLER);

		if (object)
		{
			Commands->Send_Custom_Event(obj, object, 104, 25, 0);
			Commands->Send_Custom_Event(obj, Commands->Find_Object(401741), 0, 0, 0);
		}
...
DECLARE_SCRIPT (MDD_Flying_Vehicle, "Unit_ID:int")
{
	...
	void Destroyed (GameObject* obj)
	{
		...
		if (object)
		{
			...
			if (!unit_id)
			{
				Commands->Send_Custom_Event(obj, object, 180, 0, 0);
			}
			else
			{
				Commands->Send_Custom_Event(obj, object, 181, 0, 0);
			}
		}
	}
};
