...
DECLARE_SCRIPT(MPR_A01_CivLeader_PMP, "Follower_ID:int")
{
	...
	void Created(GameObject* obj)
	{
		...
		{
			Commands->Send_Custom_Event(obj, target, MPR_CUSTOM_FOLLOW_ME_DEL, 0, 0);
	...
	void Timer_Expired(GameObject* obj, int timerID)
	{
		...
		if ((timerID == MPR_TIMER_DELAY_01_PMP) && (Commands->Find_Object(Follower_ID)) && (MPR_nod_dead_PMP == false) && (shooting == false))
		{
			...
			Commands->Send_Custom_Event(obj, Commands->Find_Object(Follower_ID), MPR_CUSTOM_FOLLOW_ME_DEL, 0, 0);
...
DECLARE_SCRIPT(MPR_A01_EscortDies_PMP,"CIV01_ID:int, CIV02_ID:int, CIV03_ID:int")
{
	...
	void Killed(GameObject*obj, GameObject* killer)
	{
		...
		MPR_nod_dead_PMP = true;
		Commands->Send_Custom_Event(obj, Commands->Find_Object(CIV01_ID), MPR_CUSTOM_I_AM_DEAD_DEL, 0, 0);
		Commands->Send_Custom_Event(obj, Commands->Find_Object(CIV02_ID), MPR_CUSTOM_I_AM_DEAD_DEL, 0, 0);
		Commands->Send_Custom_Event(obj, Commands->Find_Object(CIV03_ID), MPR_CUSTOM_I_AM_DEAD_DEL, 0, 0);
	}
};
...
DECLARE_SCRIPT(MPR_A01_SeeEnemy_PMP,"CIV01_ID:int, CIV02_ID:int, CIV03_ID:int, NOD01_ID:int")
{
	...
	void Enemy_Seen(GameObject* obj, GameObject* enemy)
	{
		...
		if ((enemy == (Commands->Get_The_Star())) && (shooting == false))
		{
			...
			Commands->Send_Custom_Event(obj, Commands->Find_Object(CIV01_ID), MPR_CUSTOM_ESCORT_ATTACKED_DEL, 0, 0);
			Commands->Send_Custom_Event(obj, Commands->Find_Object(CIV02_ID), MPR_CUSTOM_ESCORT_ATTACKED_DEL, 0, 0);
			Commands->Send_Custom_Event(obj, Commands->Find_Object(CIV03_ID), MPR_CUSTOM_ESCORT_ATTACKED_DEL, 0, 0);
			Commands->Send_Custom_Event(obj, Commands->Find_Object(NOD01_ID), MPR_CUSTOM_ESCORT_ATTACKED_DEL, 0, 0);
...
DECLARE_SCRIPT(MPR_A01_Chinook_Evac_Civies_PMP,"")
{
	...
	void Created(GameObject* obj)
	{
		...
		Commands->Set_Animation(obj, "V_GDI_CHINOOKE3.m_ch_evacland", false, NULL, 0.0f, -1.0f, false);
	}
	...
	void Animation_Complete(GameObject* obj, const char* name)
	{
		...
		{
			Commands->Set_Animation(obj, "V_GDI_CHINOOKE3.m_ch_evacloiter", true, NULL, 0.0f, -1.0f, false);
			Commands->Start_Timer(obj, 13, MPR_TIMER_EVAC_PMP );

			if (Commands->Find_Object(CIV01_ID))
			{
				Commands->Send_Custom_Event(obj, Commands->Find_Object(CIV01_ID), MPR_CUSTOM_EVAC_CALL_DEL, 0, 0);
			}
			if (Commands->Find_Object(CIV02_ID))
			{	
				Commands->Send_Custom_Event(obj, Commands->Find_Object(CIV02_ID), MPR_CUSTOM_EVAC_CALL_DEL, 0, 0);
			}
			if (Commands->Find_Object(CIV03_ID))
			{
				Commands->Send_Custom_Event(obj, Commands->Find_Object(CIV03_ID), MPR_CUSTOM_EVAC_CALL_DEL, 0, 0);
			}
		}
	}
	...
	void Timer_Expired (GameObject* obj, int Timer_ID)
	{
		...
		{
			Commands->Set_Animation(obj, "V_GDI_CHINOOKE3.m_ch_evacoff", false, NULL, 0.0f, -1.0f, false);
		}
	}
};
...
DECLARE_SCRIPT(MPR_A03_Bridge_Exploding_DEL, "AnimationName=:string")
{
	...
	void Custom(GameObject* game_obj, int type, int, GameObject*)
	{
		...
		if (type == MPR_CUSTOM_EXPLODE_BRIDGE_DEL) {
			const char* animName = Get_Parameter("AnimationName");
			Commands->Set_Animation(game_obj, animName, false, NULL, 0.0f, -1.0f, false);
		}
	}
};
...
DECLARE_SCRIPT(MPR_A03_Bridge_Trigger_DEL, "BridgeID=:int")
{
	void Entered(GameObject* obj, GameObject* enterer)
	{
		...
		if (enterer == Commands->Get_The_Star())
		{
			...
			if (dest_obj != NULL)
			{
				Commands->Send_Custom_Event(obj, dest_obj, MPR_CUSTOM_EXPLODE_BRIDGE_DEL, 0, 0);
			}
		}
	}
};
...
//			Vector3 extent = Commands->Get_Extent(tiberium);		// See Byon for a new way to do this, if needed
	...
	void Harvest(void)
	{
		...
		{
			Commands->Set_Animation(Owner(), "v_nod_harvester.m_harvesting", true, NULL, 0.0f, -1.0f, false);
...
DECLARE_SCRIPT(MPR_ApacheController, "")
{
	...
	void Created(GameObject*)
	{
		...
		//David Y.
		//Commands->Set_Animation(Owner(), "V_APACHE-E3.M_AP_POSITION1", true, NULL, 0.0f, -1.0f, false);
		// Rotor anim fix

		Vector3 origin(0.0f, 0.0f, 0.0f);
		Commands->Set_Position(Owner(), origin);
		Commands->Set_Facing(Owner(), 0.0f);
		Commands->Set_Animation(Owner(), "M_AP_POSITION1", true, NULL, 0.0f, -1.0f, false);
	...
	void Goto_Position(ApachePosition position)
	{
		...
		if ((position != mCurrentPosition) || (position != mDesiredPosition))
		{
			...
			Commands->Set_Animation(Owner(), transition.TransitionAnim, false, NULL, 0.0f, -1.0f, false);
		}
	}
	...
	void Animation_Complete(GameObject* apache, const char* finishedAnim)
	{
		...
		if (stricmp(animName, transition.TransitionAnim) == 0)
		{
			...
			Commands->Set_Animation(Owner(), transition.HoverAnim, true, NULL, 0.0f, -1.0f, false);
		}
	}
...
DECLARE_SCRIPT(MPR_A01_Orca_Strike_On_Turret_RAD, "Target_Number:int, AnimationName:string, Fire_01:int, Fire_02:int, Fire_03:int, Fire_04:int, Fire_05:int, Fire_06:int")
{
	...
	void Custom(GameObject* p_obj, int n_type, int n_param, GameObject* p_sender)
	{
		if (n_type == MPR_A01_CUSTOM_ORCA_TURRETSTRIKE_RAD)
		{
			...
			v_target_loc.Z += 0.5f;
			Commands->Set_Animation(p_obj, Get_Parameter("AnimationName"), false, NULL, 0.0f, -1.0f, false);
	...
	void Damaged(GameObject* p_obj, GameObject* p_damager)
	{
		if ((p_damager == Commands->Get_The_Star()) && (!MPR_A01_startstrike_RAD))
		{
			...
			if (p_orca1)
			{
				...
				Commands->Send_Custom_Event(p_obj, p_orca1, MPR_A01_CUSTOM_ORCA_TURRETSTRIKE_RAD, 0, 0);
			}
			else
			{
			...
			if (p_orca2)
			{
				...
				Commands->Send_Custom_Event(p_obj, p_orca2, MPR_A01_CUSTOM_ORCA_TURRETSTRIKE_RAD, 0, 0);
			}
			else
			{
	...
	void Timer_Expired( GameObject * obj, int timer_id )
	{
		if ( timer_id == apache1_die ) 
		{
			...
			if (apache1 != NULL)
			{
				...
				Commands->Create_Explosion("Generic Air 02", explosion1 , NULL);
			}
			if (apache2 != NULL)
			{
				Vector3 explosion2 = Commands->Get_Bone_Position( apache2, "SEAT" );
				Commands->Create_Explosion("Generic Air 02", explosion2 , NULL);
			}
		}
...
DECLARE_SCRIPT(MPR_A05_C130_Dropoff_Animation_RMV, "Cinematic=:string,ObjToCreate=:string,DropFrame=:int,BoneName=:string")
{
	...
	void Created( GameObject * obj )
	{
		Commands->Set_Animation(obj, Get_Parameter( "Cinematic" ), false, NULL, 0.0f, -1.0f, false);
	...
	void Timer_Expired ( GameObject* obj, int Timer_ID )
	{
		if ( Timer_ID == MPR_A05_TIMER_DROP_OBJECT_RMV )
		{
			...
			Commands->Send_Custom_Event(obj, Commands->Find_Object(8649 ), 0, 0 , 0);
...
DECLARE_SCRIPT(MPR_A05_A10_Air_Strike_RMV, "") 
{
	...
	void Timer_Expired ( GameObject* obj, int timer_id )
	{
		if ( timer_id == GO )
		{
			Commands->Set_Animation(obj, "v_gdi-a10e3.m_a10strike_a", false, NULL, 0.0f, -1.0f, false);
		}
		if ( timer_id == SHOOT )
		{
...
DECLARE_SCRIPT(MPR_A01_Intro_Cinematic_RMV, "")
{
	...
	void Timer_Expired(GameObject * obj, int timer_id)
	{
		...
		if ( timer_id == INTRO )
		{
			...
			Commands->Set_Animation(Commands->Get_The_Star(), "s_a_human.m_havok_e3pose", false, NULL, 0.0f, -1.0f, false);
...
DECLARE_SCRIPT(MPR_A02_Drill_Instructor_JDG, "")
{
	...
	void Custom (GameObject* obj, int Type, int Param, GameObject* Sender)
	{
		...
		if ((Type == MPR_A02_CUSTOM_CADET_1_JDG) && (Param == MPR_A02_PARAM_CADETS_AT_ATTENTION_JDG))
		{
			...
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J04C", false, NULL, 0.0f, -1.0f, false);
	...
	void Ten_Hut (GameObject* obj)
	{
		...
		if (Commands->Find_Object(MPR_A02_cadet_2_id_JDG))
		{
			...
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J18C", false, NULL, 0.0f, -1.0f, false);
	...
	void Choose_Cadet (void)
	{
		...
		if ((cadet > 0) && (cadet <= 33))
		{
			if (Commands->Find_Object(MPR_A02_cadet_1_id_JDG))
			{
				...
				Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_1_id_JDG)), "S_A_HUMAN.H_A_J09C", false, NULL, 0.0f, -1.0f, false);
		...
		else if ((cadet > 33) && (cadet <= 66))
		{
			if (Commands->Find_Object(MPR_A02_cadet_2_id_JDG))
			{
				...
				Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_2_id_JDG)), "S_A_HUMAN.H_A_J09C", false, NULL, 0.0f, -1.0f, false);
		...
		else
		{
			if (Commands->Find_Object(MPR_A02_cadet_3_id_JDG))
			{
				...
				Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_3_id_JDG)), "S_A_HUMAN.H_A_J09C", false, NULL, 0.0f, -1.0f, false);
	...
	void Rag_On_Cadet (int Cadet_Number)
	{
		...
		Commands->Set_Animation((Commands->Find_Object(MPR_A02_drill_instructor_id_JDG)), "S_A_HUMAN.H_A_J07C", false, NULL, 0.0f, -1.0f, false);
	...
	void Timer_Expired (GameObject* obj, int Timer_ID)
	{
		...
		if ((Timer_ID == MPR_A02_TIMER_DRILL_INSTRUCTOR_ATTACK_DELAY_JDG) && (Commands->Find_Object(MPR_A02_drill_instructor_id_JDG)) && (state == DI_INNATE))
		{
			...
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_DIV1", false, NULL, 0.0f, -1.0f, false);
			//forward roll
		}
	}
	...
	void Next_Exercise (void)
	{
		...
		if ((exercise == PUSHUPS) && (Commands->Find_Object(MPR_A02_drill_instructor_id_JDG)))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_drill_instructor_id_JDG)), "S_A_HUMAN.H_A_J04C", false, NULL, 0.0f, -1.0f, false);
			//S_A_HUMAN.H_A_J04C is animation for give order
...
DECLARE_SCRIPT(MPR_A02_Drill_Cadet_1_JDG, "")
{
	...
	void Timer_Expired (GameObject* obj, int Timer_ID)
	{
		if ((Timer_ID == MPR_A02_TIMER_CADET_1_ATTACK_DELAY_JDG) && (state == CADET_1_INNATE))
		{
			...
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_D2A3", false, NULL, 0.0f, -1.0f, false);
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_1_TEN_HUT_DELAY_JDG) && (state != CADET_1_INNATE))
		{
			...
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_A0A0", false, NULL, 0.0f, -1.0f, false);
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_1_PUSHUPS_DELAY_JDG) && (state != CADET_1_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_1_id_JDG)), "S_A_HUMAN.H_A_J43C", false, NULL, 0.0f, -1.0f, false);
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_1_SITUPS_DELAY_JDG) && (state != CADET_1_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_1_id_JDG)), "S_A_HUMAN.H_A_J13C", false, NULL, 0.0f, -1.0f, false);
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_1_JUMPING_JACKS_DELAY_JDG) && (state != CADET_1_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_1_id_JDG)), "S_A_HUMAN.H_A_J43A" , false, NULL, 0.0f, -1.0f, false);
	...
	void Animation_Complete (GameObject* obj, const char* name)
	{
		if ((stricmp(name, "S_A_HUMAN.H_A_J43C") == 0) && (state != CADET_1_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_1_id_JDG)), "S_A_HUMAN.H_A_J13A", false, NULL, 0.0f, -1.0f, false);
		}
...
DECLARE_SCRIPT(MPR_A02_Drill_Cadet_2_JDG, "")
{
	...
	void Timer_Expired (GameObject* obj, int Timer_ID)
	{
		if ((Timer_ID == MPR_A02_TIMER_CADET_2_ATTACK_DELAY_JDG) && (state == CADET_2_INNATE))
		{
			...
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_D2B2", false, NULL, 0.0f, -1.0f, false);
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_2_PUSHUPS_DELAY_JDG) && (state != CADET_2_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_2_id_JDG)), "S_A_HUMAN.H_A_J43C", false, NULL, 0.0f, -1.0f, false);
			//S_A_HUMAN.H_A_J13B is animation for pushups
		}
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_2_SITUPS_DELAY_JDG) && (state != CADET_2_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_2_id_JDG)), "S_A_HUMAN.H_A_J13C", false, NULL, 0.0f, -1.0f, false);
			//S_A_HUMAN.H_A_J14C is animation for situps
		}
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_2_JUMPING_JACKS_DELAY_JDG) && (state != CADET_2_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_2_id_JDG)), "S_A_HUMAN.H_A_J43A" , false, NULL, 0.0f, -1.0f, false);
			//S_A_HUMAN.H_A_J43B is animation for j-jacks
		}
	...
	void Animation_Complete (GameObject* obj, const char* name)
	{
		if ((stricmp(name, "S_A_HUMAN.H_A_J43C") == 0) && (state != CADET_2_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_2_id_JDG)), "S_A_HUMAN.H_A_J13A", false, NULL, 0.0f, -1.0f, false);
		}
...
DECLARE_SCRIPT(MPR_A02_Drill_Cadet_3_JDG, "")
{
	...
	void Timer_Expired (GameObject* obj, int Timer_ID)
	{
		if ((Timer_ID == MPR_A02_TIMER_CADET_3_ATTACK_DELAY_JDG) && (state == CADET_3_INNATE))
		{
			...
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_D2A4", false, NULL, 0.0f, -1.0f, false);
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_3_PUSHUPS_DELAY_JDG) && (state != CADET_3_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_3_id_JDG)), "S_A_HUMAN.H_A_J43C", false, NULL, 0.0f, -1.0f, false);
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_3_SITUPS_DELAY_JDG) && (state != CADET_3_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_3_id_JDG)), "S_A_HUMAN.H_A_J13C", false, NULL, 0.0f, -1.0f, false);
			//S_A_HUMAN.H_A_J14C is animation for situps
		}
		...
		if ((Timer_ID == MPR_A02_TIMER_CADET_3_JUMPING_JACKS_DELAY_JDG) && (state != CADET_3_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_3_id_JDG)), "S_A_HUMAN.H_A_J43A" , false, NULL, 0.0f, -1.0f, false);
			//S_A_HUMAN.H_A_J43B is animation for j-jacks
		}
	...
	void Animation_Complete (GameObject* obj, const char* name)
	{
		if ((stricmp(name, "S_A_HUMAN.H_A_J43C") == 0) && (state != CADET_3_INNATE))
		{
			...
			Commands->Set_Animation((Commands->Find_Object(MPR_A02_cadet_3_id_JDG)), "S_A_HUMAN.H_A_J13A", false, NULL, 0.0f, -1.0f, false);
		}
...
DECLARE_SCRIPT(MPR_A04_SuicideRun_GDI_Minigunner_1_JDG, "")
{
	...
	{	
		...
		{
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J33C", false, NULL, 0.0f, -1.0f, false);
	...
	void Animation_Complete (GameObject* obj, const char* name)
	{
		...
		{
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J15C", false, NULL, 0.0f, -1.0f, false);
		}

		if ((stricmp(name, "S_A_HUMAN.H_A_J15C") == 0)) 
		{
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J03C", false, NULL, 0.0f, -1.0f, false);
		}
...
DECLARE_SCRIPT(MPR_A04_SuicideRun_GDI_Minigunner_2_JDG, "")
{
	...
	{	
		...
		{
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J09C", false, NULL, 0.0f, -1.0f, false);
		}
	}
	...
	void Animation_Complete (GameObject* obj, const char* name)
	{
		...
		{
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J10C", false, NULL, 0.0f, -1.0f, false);
		}

		if ((stricmp(name, "S_A_HUMAN.H_A_J10C") == 0)) 
		{
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J11C", false, NULL, 0.0f, -1.0f, false);
		}
...
DECLARE_SCRIPT(MPR_A03_Helicopter_Injured_NOD_Pilot_JDG, "")
{
	...
	void Timer_Expired (GameObject*obj, int Timer_ID)
	{
		if ((Timer_ID == MPR_A03_TIMER_INJURED_PILOT_CRAWL_1_JDG) && (Commands->Find_Object(MPR_A03_helicopter_injured_nod_pilot_id_JDG)))
		{
			...
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_H11C", false, NULL, 0.0f, -1.0f, false);
	...
	void Animation_Complete (GameObject* obj, const char* name)
	{
		...
		{
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_611A", false, NULL, 0.0f, -1.0f, false);
		...
		{
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J22C", false, NULL, 0.0f, -1.0f, false);
...
DECLARE_SCRIPT(MPR_A03_BridgeScene_Engineer_JDG, "")
{
	...
	void Timer_Expired (GameObject* obj, int Timer_ID)
	{
		if ((Timer_ID == MPR_A03_TIMER_BRIDGESCENE_ENGINEER_HAVOC_IN_ZONE_DELAY_JDG) && (Commands->Find_Object(MPR_A03_bridgescene_engineer_id_JDG)))
		{
			...
			Commands->Set_Animation(obj, "S_A_HUMAN.H_A_J12C", false, NULL, 0.0f, -1.0f, false);
