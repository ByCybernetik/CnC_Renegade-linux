			...
			case PHYS_CHUNK_VARIABLES:
				while (cload.Open_Micro_Chunk()) {
					switch(cload.Cur_Micro_Chunk_ID()) {
						// (gth) not saving observer pointers any more!
						READ_MICRO_CHUNK_WIRE_POINTER(cload,PHYS_VARIABLE_CULLABLE_PTR,cullable_ptr);
						READ_MICRO_CHUNK_WIRE_POINTER(cload,PHYS_VARIABLE_WIDGETUSER_PTR,widgetuser_ptr);
						READ_MICRO_CHUNK_WIRE_POINTER(cload,PHYS_VARIABLE_EDITABLE_PTR,editable_ptr);
