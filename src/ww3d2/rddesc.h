...
public:
	...
	RenderDeviceDescClass(void) : DeviceName((const TCHAR*)0), DeviceVendor((const TCHAR*)0), DevicePlatform((const TCHAR*)0),
											DriverName((const TCHAR*)0), DriverVendor((const TCHAR*)0), DriverVersion((const TCHAR*)0),
											HardwareName((const TCHAR*)0), HardwareVendor((const TCHAR*)0), HardwareChipset((const TCHAR*)0)
	{
	}
