...
class TextureClass : public RefCountClass
{
	...
	public:
		...
		void *Peek_Vulkan_Texture() const { return Vulkan_Texture; }
		void Set_Vulkan_Texture(void *texture) { Vulkan_Texture = texture; }
		void Set_Dimensions(int width, int height) { Width = width; Height = height; }
		void Mark_Vulkan_Initialized() { Initialized = true; }
#endif
