...
public:
	...
	bool							cast_obbox_brute_force_world(OBBoxCollisionTestClass & worldtest, const Matrix3D & mesh_to_world);
	bool							intersect_obbox_brute_force_world(OBBoxIntersectionTestClass & worldtest, const Matrix3D & mesh_to_world);
