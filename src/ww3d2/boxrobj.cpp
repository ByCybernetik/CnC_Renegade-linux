...
{
	if ( !LINUX_BOX_CAST_GATE ( *this, raytest.CollisionType ) ) {
		return false;
	}
#if defined(RENEGADE_COLLISION_FIX)
	update_cached_box();
...
{
	if ( !LINUX_BOX_CAST_GATE ( *this, boxtest.CollisionType ) ) {
		return false;
	}
#if defined(RENEGADE_COLLISION_FIX)
	update_cached_box();
...
{
	if ( !LINUX_BOX_INTERSECT_GATE ( *this, boxtest.CollisionType ) ) {
		return false;
	}
#if defined(RENEGADE_COLLISION_FIX)
	update_cached_box();
