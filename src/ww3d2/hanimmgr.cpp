...
void	HAnimManagerClass::Unregister_Missing( const char * name )
{
	MissingAnimClass *missing = (MissingAnimClass *)MissingAnimTable->Find( name );
	if ( missing != NULL ) {
		MissingAnimTable->Remove( missing );
		delete missing;
	}
}
