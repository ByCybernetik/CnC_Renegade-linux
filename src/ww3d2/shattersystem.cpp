...
void ShatterSystem::Init(void)
{
	...
	*/
	...
	for (;;) {
		htree_name.Format(SHATTER_PATTERN_FORMAT, pattern_index);
		...
		/*
		** Advance the pattern index even when the tree is rejected; otherwise a
		** loadable but invalid ShatterPlanesN traps the loader in a tight loop.
		*/
		++pattern_index;
