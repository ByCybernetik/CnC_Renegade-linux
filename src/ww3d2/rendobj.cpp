			...
			case RENDOBJFACTORY_CHUNKID_VARIABLES:
			{
				while (cload.Open_Micro_Chunk()) {
					switch(cload.Cur_Micro_Chunk_ID()) {
						READ_MICRO_CHUNK_WIRE_POINTER(cload, RENDOBJFACTORY_VARIABLE_OBJPOINTER, old_obj);	
...
void RenderObjPersistFactoryClass::Save(ChunkSaveClass & csave,PersistClass * obj)	const
{
	...
	WRITE_MICRO_CHUNK_WIRE_POINTER(csave,RENDOBJFACTORY_VARIABLE_OBJPOINTER,robj);
