...
SoundSceneObjClass::Save (ChunkSaveClass &csave)
{
	...
	csave.Begin_Chunk (CHUNKID_VARIABLES);		
		WRITE_MICRO_CHUNK_WIRE_POINTER (csave, VARID_ATTACHED_OBJ, m_AttachedObject);
		WRITE_MICRO_CHUNK (csave, VARID_ATTACHED_BONE, m_AttachedBone);		
		WRITE_MICRO_CHUNK (csave, VARID_USER_DATA, m_UserData);
		WRITE_MICRO_CHUNK_WIRE_POINTER (csave, VARID_USER_OBJ, m_UserObj);
			...
			case CHUNKID_VARIABLES:
			{
				...
				while (cload.Open_Micro_Chunk ()) {
					switch (cload.Cur_Micro_Chunk_ID ()) {
						...
						READ_MICRO_CHUNK_WIRE_POINTER (cload, VARID_ATTACHED_OBJ, m_AttachedObject);
						READ_MICRO_CHUNK (cload, VARID_ATTACHED_BONE, m_AttachedBone);
						READ_MICRO_CHUNK (cload, VARID_USER_DATA, m_UserData);
						READ_MICRO_CHUNK_WIRE_POINTER (cload, VARID_USER_OBJ, m_UserObj);
