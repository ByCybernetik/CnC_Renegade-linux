...
)
{
	...
	if (list_ctrl->Get_Entry_Data (item_index1, 0) == NULL) {
		...
		uintptr_t data1 = list_ctrl->Get_Entry_Data (item_index1, 0);
		uintptr_t data2 = list_ctrl->Get_Entry_Data (item_index2, 0);
		InputConfigClass *config1 = (InputConfigClass *)data1;
		InputConfigClass *config2 = (InputConfigClass *)data2;
		//
