...
static void Eva_Set_Tab_Image_Texture (DialogBaseClass *dialog, int ctrl_id, const char *texture_name)
{
	if (dialog == NULL || texture_name == NULL) {
		return;
	}

	DialogControlClass *control = dialog->Get_Dlg_Item (ctrl_id);
	ImageCtrlClass *image = control ? control->As_ImageCtrlClass () : NULL;
	if (image == NULL) {
		return;
	}
...
////////////////////////////////////////////////////////////////
void
EvaDataTabClass::Start_Dialog (void)
{
...
EvaDataTabClass::Fill_Statistics_List (void)
{
	...
	Eva_Set_Tab_Image_Texture (this, IDC_GAME_TIME_IMAGE, "if_GameTime.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_WEAPONS_IMAGE, "if_Weapons.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_POWERUPS_IMAGE, "if_PowerUps.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_FRIENDLIES_IMAGE, "if_casualties.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_SHOTS_FIRED_IMAGE, "if_Ammo.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_ACCURACY_IMAGE, "if_Percentage.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_ENEMIES_KILLED_IMAGE, "if_NodKills.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_VEHICLE_TIME_IMAGE, "if_VehicleTime.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_VEHICLE_KILLS_IMAGE, "if_VehiclesKill.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_VEHICLE_SQUISHES_IMAGE, "if_RunOvers.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_VEHICLES_DESTROYED_IMAGE, "if_KillVehicles.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_BUILDINGS_DESTROYED_IMAGE, "if_buildingsKill.tga");
	Eva_Set_Tab_Image_Texture (this, IDC_HIT_MAP_IMAGE, "if_NodHits128.tga");
