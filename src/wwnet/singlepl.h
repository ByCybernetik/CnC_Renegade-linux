...
class cSinglePlayerData
{
	public:
		...
		static void Enable_Lan_Host_Local_Client(bool enable);
		static bool Is_Single_Player() {return IsSinglePlayer;}
		static bool Is_Lan_Host_Local_Client() {return IsLanHostLocalClientOnly;}
		static bool Uses_In_Process_Client() {return IsSinglePlayer || IsLanHostLocalClientOnly;}

		static SList<cPacket> * Get_Input_Packet_List(int type);

   private:
		static void Clear_Input_Packet_Lists(void);

		static bool IsSinglePlayer;
		static bool IsLanHostLocalClientOnly;
