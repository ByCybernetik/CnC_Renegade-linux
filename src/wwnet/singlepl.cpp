...
bool cSinglePlayerData::IsLanHostLocalClientOnly = false;
SList<cPacket> cSinglePlayerData::InputPacketList[];

//-----------------------------------------------------------------------------
void cSinglePlayerData::Clear_Input_Packet_Lists(void)
{
...
//-----------------------------------------------------------------------------
void cSinglePlayerData::Enable_Lan_Host_Local_Client(bool enable)
{
	if (IsLanHostLocalClientOnly && !enable) {
		Clear_Input_Packet_Lists();
	}
	IsLanHostLocalClientOnly = enable;
}
...
void cSinglePlayerData::Cleanup() 
{
   ...
   IsLanHostLocalClientOnly = false;
}
